"""Unit tests for the base PolperroEntity."""
...
from custom_components.lexent_polperro.entity import PolperroEntity
...
class TestPolperroEntity:
    """Tests for PolperroEntity base class."""

    def test_unique_id_combines_mac_and_key(self) -> None:
        """unique_id is MAC_key."""
        coordinator = _make_coordinator()
        entity = PolperroEntity(coordinator, "test_key")
