...
from custom_components.lexent_polperro.sensor import SENSORS, PolperroSensor, async_setup_entry
...
class TestSensorNativeValue:
    ...
    def test_callable_value_fn_pm25(self) -> None:
        ...
        entity = PolperroSensor(coordinator, _get_desc("pm25_quality"))
...
class TestSensorSetupEntry:
    ...
    async def test_setup_adds_seven_sensors(self) -> None:
        ...
        assert len(added) == 7
        assert all(isinstance(e, PolperroSensor) for e in added)
